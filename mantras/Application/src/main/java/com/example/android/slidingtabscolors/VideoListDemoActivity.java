...
public final class VideoListDemoActivity extends Activity implements OnFullscreenListener {
  ...
  public static final class VideoListFragment extends ListFragment {
    ...
    static {
      ...
      list.add(new VideoEntry("Shani Mantra - Shani Mahamantra - Shani Dev Mantra 108 times - ", "PEqpwGFwU8w"));
      list.add(new VideoEntry("Shani Beej Mantra By Shailendra Bhartti I Sampoorna Shani Vandan", "IcrRgmIUpfs"));
      list.add(new VideoEntry("Maha Mrityunjaya Mantra | 108 Times Chanting By 21 Brahmins| Shiva Maha Mantra", "ZDuhp5o8Ybw"));
      list.add(new VideoEntry("Shani Mantra Mahendra Kapoor Nilanjan Samabhasam Raviputram I Shani Mahamantra", "NQIfv7-k_Pw"));
      list.add(new VideoEntry("Shani Hanuman Mantra - Hindi Devotional Songs", "8VQBxeU-K5Q"));
